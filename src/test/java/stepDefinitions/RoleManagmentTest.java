...
public class RoleManagmentTest {
	...
	@And("Admin logins with email and password")
	...
	@And("Admin clicks on Registered Accounts tab")
	...
	public void Admin_changes_the_first_user_role_to_Employee()
	{
		...
		Assert.assertEquals("Employee".toUpperCase(), current_role.getText());
	...
	@And("The user logins with their email address and password")
